...
<図2> 責務の分離後  
<img src="img/after-separation-of-responsibility.png" width=50%>
...
そこで活用されるのがアーキテクチャです。ここではアーキテクチャとは「アプリの大まかなレイヤー分割の捉え方」と認識しておいてください(イメージは<図3>のようなものです)。  
...
:--: | :--:
<img src="img/gui-architecture.png" width=70%> | <img src="img/system-architecture.png" width=70%>
...
<img src="img/passive-view.png" width=60%>
...
<img src="img/supervising-controller.png" width=60%>
...
<img src="img/data-binding.png" width=60%>
...
<図4>  
<img src="img/marble-diagrams.png" width=60%>
...
起動時 | 正常時 | エラー時
:--: | :--: | :--:
<img src="img/start-up.png" width=70%> | <img src="img/normal.png" width=70%> | <img src="img/error.png" width=70%>
...
<img src="img/clean-architecture.png" width=60%>
...
<img src="img/dependency-inversion-principle.png" width=60%>
...
<img src="img/asynchronous-value-delivery.png" width=60%>  
...
<img src="img/viper.png" width=60%>
